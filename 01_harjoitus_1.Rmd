...
:::{.note-box}
[http://www.qgis.org/fi/site/](http://www.qgis.org/fi/site/)
:::
...
:::{.note-box}
[Kurssihakemisto.zip](https://drive.google.com/file/d/141J1hHF4KfN9XVv3SJn93cTv1_QZMo5p/view?usp=sharing)
:::
...
Huomaa, että kielen vaihtamisen aktivoimiseksi sinun tulee käynnistää QGIS uudelleen.
...
### Attribuuttitaulu
Valitse TieViiva-karttataso ja avaa ominaisuustietotaulukko, joko painamalla  pikakuvaketta ![](img/harjoitus_1/image2.png) tai painamalla hiiren oikealla näppäimellä karttatason kohdalla sekä valitsemalla **Avaa attribuuttitaulu**.
